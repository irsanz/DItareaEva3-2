...
export class Tab1Page {
 ...
 /* private leerArticulosFichero(){
  ...
  private leerArticulosRest() {
    ...
    let respNoticiasObservable: Observable<RespuestaNoticias> = this.leerArticulosRestHttp.get<RespuestaNoticias>("https://newsapi.org/v2/top-headlines?country=us&apiKey=c6f2e26e9fa440f58852d626a45feedc");
